fablesCollection = [ {
	...
	endIndex : 9,
	descriptors : [ {
		name : "the-shepherd-boy-and-the-wolf",
		title : "The Shepherds Boy and the Wolf",
		moral : "A liar will not be believed, even when he speaks the truth.",
		leftIndex : 0,
		topIndex : 0
	}, {
		name : "the-wolf-in-sheep-clothing",
		...
		name : "the-lion-and-the-gnat",
		title : "The Lion and the Gnat",
		moral : "The least of our enemies is often the most to be feared.",
		leftIndex : 3,
		topIndex : 3
	} ]
}, {
	...
	descriptors : [ {
		...
		name : "the-wolf-and-the-shepherd",
		title : "The Wolf and the Shepherd",
		moral : "An evil mind will show in evil action, sooner or later.",
		leftIndex : 3,
		topIndex : 0
	}, {
		name : "the-wolf-and-the-ass",
		title : "The Wolf and the Ass",
		moral : "Stick to your trade.",
		leftIndex : 0,
		topIndex : 1
	}, {
		name : "the-oak-and-the-reeds",
		title : "The Oak and the Reeds",
		moral : "Better to yield when it is folly to resist, than to resist stubbornly and be destroyed.",
		leftIndex : 1,
		topIndex : 1
	}, {
		name : "the-old-lion-and-the-fox",
	...
	endIndex : 29,
	descriptors : [ {
		name : "three-bullocks-and-a-lion",
		title : "Three Bullocks and a Lion",
		moral : "In unity is strength.",
		leftIndex : 0,
		topIndex : 0
	}, {
		name : "the-mother-and-the-wolf",
		...
		name : "the-bees-and-wasps-and-the-hornet",
		title : "The Bees and the Wasp and the Hornet",
		moral : "Ability proves itself by deeds.",
		leftIndex : 3,
		topIndex : 0
	}, {
		name : "the-wolf-and-the-house-dog",
		title : "The Wolf and the House Dog",
		moral : "There is nothing worth so much as liberty.",
		leftIndex : 1,
		topIndex : 1
	}, {
		name : "the-wolf-and-the-kid",
		title : "The Wolf and the Kid",
		moral : "Every one should keep his own habits.",
		leftIndex : 0,
		topIndex : 2
	}, {
		name : "the-shepherd-and-the-lion",
		title : "The Shepherd and the Lion",
		moral : "Do not foolishly ask for things that would bring ruin if they were granted.",
		leftIndex : 2,
		topIndex : 2
	}, {
		name : "the-stag-the-sheep-and-the-wolf",
		title : "The Stag, the Sheep and the Wolf",
		moral : "Two blacks do not make one white.",
		leftIndex : 1,
		topIndex : 3
	}, {
		name : "the-travelers-and-the-purse",
		title : "The Travelers and the Purse",
		moral : "We cannot expect any one to share our misfortunes unless we are willing to share our good fortune also.",
		leftIndex : 2,
		topIndex : 3
	}, {
		name : "the-gnat-and-the-bull",
	...
	descriptors : [ {
		...
		name : "the-heron",
		title : "The Heron",
		moral : "Do not be too hard to suit or you may have to be content with the worst.",
		leftIndex : 1,
		topIndex : 2
	}, {
	...
	descriptors : [ {
		...
		name : "the-dog-and-his-reflection",
	...
	descriptors : [ {
		...
		name : "the-lark-and-her-young-ones",
	...
	descriptors : [ {
		...
		name : "the-monkey-and-the-dolphin",
		title : "The Monkey and the Dolphin",
		moral : "Who begins to tell falsehoods, sooner or later, will get into trouble.",
		leftIndex : 2,
		topIndex : 2
	}, {
		name : "the-lion-the-ass-and-the-fox",
		...
		name : "the-owl-and-the-grasshopper",
	...
	endIndex : 89,
	descriptors : [ {
		name : "the-dog-the-cock-and-the-fox",
	...
	descriptors : [ {
		...
		moral : "Invitations prompted by selfishness are not to be accepted.",
		leftIndex : 1,
		topIndex : 0
	}, {
		...
		name : "the-frog-and-the-mouse",
		title : "The Frog and the Mouse",
		moral : "People who do harm to others ends-up destroying themselves.",
		leftIndex : 3,
		topIndex : 0
	}, {
		name : "the-monkey-and-the-cat",
		title : "The Monkey and the Cat",
		moral : "The flatterer seeks some benefit at your expense.",
		leftIndex : 2,
		topIndex : 1
	}, {
		name : "the-milkmaid-and-her-pail",
		title : "The Milkmaid and Her Pail",
		moral : "Do not count your chickens before they are hatched.",
		leftIndex : 0,
		topIndex : 2
	}, {
		name : "the-hare-and-his-ears",
		title : "The Hare and His Ears",
		moral : "Do not give your enemies the slightest reason to attack your reputation.",
		leftIndex : 2,
		topIndex : 2
	}, {
		name : "the-peacock-and-the-crane",
		title : "The Peacock and the Crane",
		moral : "Fine feathers don't make fine birds.",
		leftIndex : 3,
		topIndex : 2
	}, {
		name : "the-sheep-and-the-pig",
...
com.kidscademy.fables.SectionView.prototype._getFablesList = function() {
	return {
		setFableView : function() {
		},
		on : function() {
		}
	};
...
WinMain.on("load", function() {
	WinMain.page.getEventManager = function() {
		return new js.event.Manager();
	};

	var section = WinMain.doc.getByCssClass("fables-section");
	section.setObject(fablesCollection[0]);
	section.setFocus();
});
